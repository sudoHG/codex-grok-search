...
请从 [v0.1.0-rc.2 Release 页面](https://github.com/sudoHG/codex-grok-search/releases/tag/v0.1.0-rc.2)下载资产。安装完成后，重启 Codex 或新建一个任务。
...
当前发布候选已经完成单元测试、结构校验、真实 X / Reddit canary 和可复现资产检查。GitHub Release 资产从带 tag 的仓库提交构建，并在 Draft Release 正式发布前再次校验。
